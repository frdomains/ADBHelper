...
if %selekshn%==1 (adb.exe shell)
if %selekshn%==2 (adb.exe logcat)
if %selekshn%==3 (goto rebutto)
if %selekshn%==4 (goto changpercent)
if %selekshn%==5 (start /min adb.exe shell dumpsys battery reset)
...
if %rbtSelekshn%==1 (adb.exe reboot)
if %rbtSelekshn%==2 (adb.exe reboot bootloader)
if %rbtSelekshn%==3 (adb.exe reboot recovery)
if %rbtSelekshn%==4 (adb.exe reboot sideload)
...
start /min adb.exe shell dumpsys battery set level %precetn%
